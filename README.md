...
2.2 ver_inventario(): Muestra el inventario de productos con sus detalles.
    Se crea una función para que se imprima todo el inventario de los productos que fueron añadidos a la lista inventario_tienda. Utiliza el bucle for para recorrer la lista. En cada vuelta del bucle imprime todos los datos de un producto con print(f""). Una vez que se hayan motrado todos los productos, se termina la función con return. 


2.3 0. buscar_producto(item): Busca un producto en el inventario por nombre y muestra sus
detalles si se encuentra. En esta función lo que se pretende es saber si un producto está o no en el inventario. Para ello utilizamos un bucle for donde al buscar el producto indicado, coincide con la descripción de item, se imprimirá los datos de ese item. si no está, se imprimirá un mensaje que indica que el producto no está en el inventario. 
...
2.5 Eliminar_producto(nombre): Elimina un producto del inventario por nombre. 
EEn esta función lo que se pretende eliminar un producto del inventario. Para ello utilizamos un bucle for donde al buscar el producto indicado, si coincide con la descripción de item, eliminará con remove los datos de ese item. si no está, se imprimirá un mensaje que indica que el producto no está en el inventario. 
